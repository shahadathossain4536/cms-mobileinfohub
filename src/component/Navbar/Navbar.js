...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-center items-center w-full mx-auto'>
      <div className=' w-full h-14 bg-slate-300 dark:bg-slate-800 flex justify-between items-center px-4'>
        <div className='w-full max-w-[220px] h-10'>
        ...
        <div className='relative'>
          <button onClick={() => setOpen(o => !o)} className='w-10 h-10 border border-black/40 dark:border-white/20 rounded-full flex items-center justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className='w-6 h-6'>
              <path d="M4 22C4 17.5817 7.58172 14 12 14C16.4183 14 20 17.5817 20 22H18C18 18.6863 15.3137 16 12 16C8.68629 16 6 18.6863 6 22H4ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13ZM12 11C14.21 11 16 9.21 16 7C16 4.79 14.21 3 12 3C9.79 3 8 4.79 8 7C8 9.21 9.79 11 12 11Z"/>
            </svg>
          </button>
          {open && (
            <div className='absolute right-0 mt-2 w-48 rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-lg z-10'>
              <div className='px-4 py-3 border-b border-slate-200 dark:border-slate-700'>
                <p className='text-sm font-medium'>{user?.email || 'Logged in'}</p>
              </div>
              <button className='w-full text-left px-4 py-2 text-sm hover:bg-slate-100 dark:hover:bg-slate-700' onClick={onLogout}>Logout</button>
            </div>
          )}
        </div>
       </div>
